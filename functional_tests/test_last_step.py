...
class TestTwoStepPuzzle(unittest.TestCase):
    def test_last_two_steps_completed(self):
        assert sudoku_solver.solve(two_steps_from_solved) == solution
